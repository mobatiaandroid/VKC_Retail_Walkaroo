...
public class VKCInternetManager {
	...
	public VKCInternetManager(String requestUrl) {
		...
		System.out.println("The api calling is" + requestUrl);
	}
	...
	public void getResponseGET(Activity activity) {
		...
		strReq.setRetryPolicy(new DefaultRetryPolicy(120 * 1000, 0,
	...
	public void getResponsePOST(Context context, String[] name, String[] value,
			ResponseListener responseListener) {
		System.out.println("inside the url call1111" + name[0] + "values is"
				+ value[0]);
		this.mResponseListener = responseListener;
	...
	public void getResponsePOST(Context context, final String[] name,
			final String[] value) {
		System.out.println("inside the url call");
		...
		// Adding request to request queue
		sr.setRetryPolicy(new DefaultRetryPolicy(120 * 1000, 0,
				DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
