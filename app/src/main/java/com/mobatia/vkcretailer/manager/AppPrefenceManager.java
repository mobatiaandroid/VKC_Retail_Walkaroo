...
public class AppPrefenceManager {
	...
	public static String getListingOption(Context context) {
		...
		settings = context.getSharedPreferences(PREFS_NAME,
				Context.MODE_PRIVATE); // 1
		text = settings.getString(LISTING_OPTION, "0"); // 2
		return text;
	}
	...
	public static String getUnit(Context context) {
		...
		settings = context.getSharedPreferences(PREFS_NAME,
				Context.MODE_PRIVATE);
		text = settings.getString("unit", "0");
		return text;
	}

	public static void saveUnit(Context context, String text) {
		SharedPreferences settings;
		Editor editor;
		settings = context.getSharedPreferences(PREFS_NAME,
				Context.MODE_PRIVATE);
		...
		editor.putString("unit", text.toString());
		editor.commit();
	}
	...
	public static String getRetailerId(Context context) {
		...
		settings = context.getSharedPreferences(PREFS_NAME,
				Context.MODE_PRIVATE);
		text = settings.getString("RetailerId", "");
		return text;
	}

	public static void setRetailerId(Context context, String text) {
		SharedPreferences settings;
		Editor editor;
		settings = context.getSharedPreferences(PREFS_NAME,
				Context.MODE_PRIVATE);
		...
		editor.putString("RetailerId", text);
		editor.commit();
	}
	public static String getRetailerName(Context context) {
		...
		settings = context.getSharedPreferences(PREFS_NAME,
				Context.MODE_PRIVATE);
		text = settings.getString("RetailerName", "");
		return text;
	}

	public static void setRetailerName(Context context, String text) {
		SharedPreferences settings;
		Editor editor;
		settings = context.getSharedPreferences(PREFS_NAME,
				Context.MODE_PRIVATE);
		...
		editor.putString("RetailerName", text);
		editor.commit();
	}
	...
	public static String getDealerId(Context context) {
		...
		settings = context.getSharedPreferences(PREFS_NAME,
				Context.MODE_PRIVATE);
		text = settings.getString("DealerId", "");
		return text;
	}

	public static void setDealerId(Context context, String text) {
		SharedPreferences settings;
		Editor editor;
		settings = context.getSharedPreferences(PREFS_NAME,
				Context.MODE_PRIVATE);
		...
		editor.putString("DealerId", text);
		editor.commit();
	}
	public static String getDealerIdName(Context context) {
		SharedPreferences settings;
		String text;
		settings = context.getSharedPreferences(PREFS_NAME,
				Context.MODE_PRIVATE);
		text = settings.getString("DealerIdName", "");
		return text;
	}

	public static void setDealerIdName(Context context, String text) {
		SharedPreferences settings;
		Editor editor;
		settings = context.getSharedPreferences(PREFS_NAME,
				Context.MODE_PRIVATE);
		...
		editor.putString("DealerIdName", text);
		editor.commit();
	}

	public static String getUserTypeSelected(Context context) {
		SharedPreferences settings;
		String text;
		settings = context.getSharedPreferences(PREFS_NAME,
				Context.MODE_PRIVATE);
		text = settings.getString("UserSelected", "0");
		return text;
	}

	public static void setUserTypeSelected(Context context, String text) {
		SharedPreferences settings;
		Editor editor;
		settings = context.getSharedPreferences(PREFS_NAME,
				Context.MODE_PRIVATE);
		...
		editor.putString("UserSelected", text);
		editor.commit();
	}
}
